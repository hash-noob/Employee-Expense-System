...
Router.get('/pending-bills/',authenticateToken,async (req, res) => {
    try {
        const pendingBills = await claimsModel.find({"status":"pending"});
...
Router.get('/approved-bills/',authenticateToken, async (req, res) => {
    ...
    try {
        const approvedBills = await claimsModel.find({status:'approved'});
...
Router.get('/rejected-bills/',authenticateToken,async (req, res) => {
    ...
    try {
        const rejectedBills = await claimsModel.find({status:'rejected'});
