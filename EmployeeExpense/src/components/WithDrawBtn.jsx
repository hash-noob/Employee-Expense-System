...
const WithdrawPopup = ({ handleClose,handleWithdraw,claim })=>(
  <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-75">
    <div className="bg-white rounded-lg p-6 w-full max-w-lg">
      ...
      <a href='' className='text-white no-underline'><button className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-10 rounded' onClick={handleWithdraw}>Yes</button></a>
